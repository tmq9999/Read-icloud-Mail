...
2. Web random một email gốc + sinh biến thể theo khả năng của nhà cung cấp: **Gmail** dấu chấm hoặc +alias; **Outlook/Hotmail/Live/MSN/iCloud/Proton/Fastmail** dùng +alias; **nhà cung cấp không hỗ trợ alias (GMX, mail.com, libero.it… và domain chưa rõ)** dùng **chính mail gốc** (không alias).
...
- **Email đa nhà cung cấp** — thêm tài khoản gốc bất kỳ; generator sinh biến thể theo khả năng: Gmail (chấm/+alias), Outlook/iCloud/… (+alias), nhà cung cấp không hỗ trợ alias (GMX/mail.com/libero.it) dùng chính mail gốc.
